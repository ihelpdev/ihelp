  ...
  return (
    <div className="min-h-screen bg-surface-container flex flex-col items-center py-10 px-4">
      ...
      <div className="w-1/2 mx-auto p-8 bg-surface rounded-2xl shadow-sm border border-outline-variant">
        <h2 className="text-headline-sm font-bold text-on-surface mb-2">Welcome back, Admin</h2>
        <p className="text-body-md text-on-surface-variant mb-6">Log in to the super admin portal.</p>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-on-surface-variant">
            Need an admin account? <a href="/admin/register" className="text-primary font-medium hover:underline">Register here</a>
          </p>
        </div>
      </div>
    </div>
